Gem::Specification.new do |s|
  ...
  s.files = ["bin/blackjack", "config/environment.rb", "lib/Card.rb", "lib/Cli.rb", "lib/Deck.rb", "lib/Game.rb", "lib/Player.rb", "lib/players/Computer.rb", "lib/players/Human.rb", "Gemfile", "README.md"]
  s.license = "MIT"
  s.homepage =
